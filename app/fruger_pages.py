...
def build_api_home_guest() -> list[AnyComponent]:
    return [
        c.Page(
            class_name=PAGE,
            components=[
        ...
        c.Page(
            ...
            components=[
                ...
                c.Div(
                    class_name=HERO,
                    components=[
                        c.Paragraph(text="Fruger", class_name="text-xs font-semibold uppercase tracking-widest text-white/60"),
                        c.Heading(
                            text="Welcome back",
                            level=1,
...
def build_api_analytics(overview: NycOverviewResponse | None, analytics_error: str | None) -> list[AnyComponent]:
    if analytics_error:
        return [
            c.Page(
                class_name=PAGE,
        ...
        c.Div(
            ...
            components=[
                c.Div(
                    ...
                    components=[
                        c.Paragraph(text=str(t.total_pickups), class_name="text-2xl font-extrabold text-fruger-on"),
                        c.Paragraph(text="Total pickups", class_name="text-xs font-semibold uppercase text-fruger-muted"),
                    ],
                ),
                c.Div(
                    class_name=STAT_TILE,
                    components=[
                        c.Paragraph(text=str(t.pickups_with_latlon), class_name="text-2xl font-extrabold text-fruger-on"),
                        c.Paragraph(text="With lat/lon", class_name="text-xs font-semibold uppercase text-fruger-muted"),
                    ],
                ),
                c.Div(
                    class_name=STAT_TILE,
                    components=[
                        c.Paragraph(text=str(t.pickups_with_zone), class_name="text-2xl font-extrabold text-fruger-on"),
                        c.Paragraph(text="With TLC zone", class_name="text-xs font-semibold uppercase text-fruger-muted"),
                    ],
                ),
                c.Div(
                    class_name=STAT_TILE,
                    components=[
                        c.Paragraph(text=str(t.distinct_bases), class_name="text-2xl font-extrabold text-fruger-on"),
                        c.Paragraph(text="Distinct bases", class_name="text-xs font-semibold uppercase text-fruger-muted"),
                    ],
                ),
            ],
        ),
    ...
    parts.extend(
        [
            ...
            c.Paragraph(text="Charts as PNG files:", class_name="text-xs font-semibold text-fruger-muted mt-4"),
            c.Div(
                class_name="flex flex-wrap gap-3 items-center",
                components=[
                    _outline_link("Borough", "/api/analytics/plots/borough.png"),
                    _outline_link("Base", "/api/analytics/plots/base.png"),
                    _outline_link("Hour", "/api/analytics/plots/hour.png"),
                    _outline_link("Pickups by date", "/api/analytics/plots/pickups-by-date.png"),
                ],
            ),
            c.Paragraph(
...
def build_driver_fastui(request_base: str) -> list[AnyComponent]:
    ...
    return [
        c.Page(
            ...
            components=[
                ...
                c.Paragraph(text="Partner", class_name="text-xs font-semibold uppercase tracking-widest text-fruger-muted"),
...
def build_admin_map_fastui(request_base: str) -> list[AnyComponent]:
    ...
    return [
        c.Page(
            ...
            components=[
                ...
                c.Paragraph(text="Fleet", class_name="text-xs font-semibold uppercase tracking-widest text-fruger-muted"),
...
def build_rider_bids_fastui(request_base: str) -> list[AnyComponent]:
    ...
    return [
        c.Page(
            ...
            components=[
                ...
                c.Paragraph(text="Rider", class_name="text-xs font-semibold uppercase tracking-widest text-fruger-muted"),
